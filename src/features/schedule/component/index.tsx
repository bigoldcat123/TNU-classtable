import { computeCurrentWeek, todayDayId } from '../week';
  ...
  return (
    <main className="h-dvh flex flex-col w-full max-w-6xl mx-auto px-4 py-6 overflow-hidden">
      ...
      <div className="flex-1 min-h-0">
        <ScheduleGrid schedule={schedule} currentWeek={currentWeek} today={today} className="hidden lg:grid h-full" />
        <MobileSchedule schedule={schedule} currentWeek={currentWeek} today={today} className="lg:hidden h-full" />
      </div>
    </main>
  );
}
